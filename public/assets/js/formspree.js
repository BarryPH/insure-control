...
function setFlashMessage(success) {
	...
	if (success) {
		messageElem.innerHTML = `Thank you for signing up! Download our pdf of the 7 things to can do right now by clicking <a class='o-linkUnderline' href='/download'>here</a>.`;
	} else {
